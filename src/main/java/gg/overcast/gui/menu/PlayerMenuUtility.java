...
public class PlayerMenuUtility {
    ...
    public <Type> Type getData(String identifier, Class<Type> classRef) {
        Object object = this.dataMap.get(identifier);
        if (object == null) return null;
        else return classRef.cast(object);
    }

    public <Type> Type getData(Enum identifier, Class<Type> classRef) {
